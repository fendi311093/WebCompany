        ...
        <div id="hs-navbar-floating-dark"
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-end gap-y-3 py-2 md:py-0 md:ps-7">
                ...
                <div class="flex items-center gap-2">
                    <button onclick="setLightMode()" class="p-2 text-white hover:text-neutral-300 dark:hidden">
                    ...
                    <button onclick="setDarkMode()" class="p-2 text-white hover:text-neutral-300 hidden dark:block">
                        <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
